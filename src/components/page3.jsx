...
const page3 = () => {
  return (
    <div className='w-full p-5 flex flex-col gap-10'>
        ...
        <Link to="/home"><button className='bg-gradient-to-r from-blue-200 to-blue-400 w-full p-4 rounded-2xl text-xl font-bold text-white shadow-sm mt-10 mb-5'>Confirm</button></Link>
    </div>
  )
}
